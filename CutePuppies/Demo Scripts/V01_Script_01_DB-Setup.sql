...
DROP DATABASE IF EXISTS CutePuppiesDemo;
CREATE DATABASE CutePuppiesDemo;
USE CutePuppiesDemo;
...
-- insert into User (RoleCode, UserName, UserPassword, UserEmail) values 
-- ('ROLE_ADMIN', 'sadukie', '$2a$10$ffs7y5b7OwYsccPXjUimy.d.m3eACk0Mhb6R4TqpxAnuGE80SnbVu', 'sarah@cutepuppies.com'), 
-- ('ROLE_AUTHOR', 'mark_e_ting', '$2a$10$ffs7y5b7OwYsccPXjUimy.d.m3eACk0Mhb6R4TqpxAnuGE80SnbVu', 'mark_ting@cutepuppies.com');
...
VALUES ('ROLE_ADMIN', '1900-01-01', null, null, 'sadukie', '$2a$10$AF0vTsjcUKLRVcZOqoRWIOUhH0rFDkaQXsJEp9/EW4pZUUzB0eezS', 'sadukie@sadukie.com');

INSERT INTO User (RoleCode, CreatedDate, UpdatedDate, DeletedDate, UserName, UserPassword, UserEmail)
VALUES ('ROLE_AUTHOR', '1900-01-01', null, null, 'mark_e_ting', '$2a$10$AF0vTsjcUKLRVcZOqoRWIOUhH0rFDkaQXsJEp9/EW4pZUUzB0eezS', 'mark@sadukie.com');